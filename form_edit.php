...
foreach ( $result as $produk_keripik) {
    ...
    $id_produk = $produk_keripik["id_produk"];
    ...
    <div id="form" class="pt-5">
            <div class="container">
                ...
                <div class="form-group mb-2">
                    ...
                    <input id="rasa" class="form-control" type="text" placeholder="Rasa" required name="rasa" value="<?=$rasa?>"/>
                </div>
                <div class="form-group mb-2">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col col-8 p-4 bg-light">
                        <form action="action.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-2">
                                <label for="rasa">Rasa</label>
                                <input id="rasa" class="form-control" type="text" placeholder="Rasa" required name="rasa"/>
                            </div>
                            <div class="form-group mb-2">
                                <label for="harga">Harga</label>
